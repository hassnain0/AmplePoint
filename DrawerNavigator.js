  ...
  useEffect(() => {
    const getRewards = async () => {
      try {
        ...
        if (Response.data && Response.data.data && Response.data.data.user_total_ample)
    ...
    <>
      {loading ? (
        ...
        <Drawer.Navigator
          ...
          initialRouteName={CompleteProfile ? 'Login' : 'Logout'}>
          <Drawer.Screen
            name="Home"
          ...
          />
          <Drawer.Screen name="MyPurchase" component={MyPurchase} initialParams={{ CompleteProfile }} options={{
            headerShown: false, drawerIcon: ({ color }) => (
              <Image source={require('./assets/Purchase.png')} style={{ width: 10, height: 15 }} />
            ),
          }} />
          <Drawer.Screen name="LocalPurchase" component={LocalPurchase} initialParams={CompleteProfile} options={{
            headerShown: false, drawerIcon: ({ color }) => (
              <Image source={require('./assets/Purchase.png')} style={{ width: 10, height: 15 }} />
            ),
          }} />
          <Drawer.Screen name="TermsCondition" component={TermsCondition} options={{
            headerShown: false, drawerIcon: ({ color }) => (
