...
import Video1 from './Screens/Video';
    ...
    <StripeProvider publishableKey='pk_test_51 NpOZ4GY4n5u6WbIlWOsccAKTTMLq7xnjfG8fFboidp6jZCx2XlssuBHyNbvBsqfGDkbVkZH2Knka498eIzAjdPZ00YZBjdzik'>
      <NavigationContainer>
        <Stack.Navigator>
          ...
          <Stack.Screen name='Video1' component={Video1} options={{ statusBarColor: '#ff3d00', headerShown: false }} />
          ...
          <Stack.Screen name='Video' component={Video1} options={{ headerShown: false }} />
          <Stack.Screen name='Drawer' component={DrawerNavigator} options={{ headerShown: false }} />
          <Stack.Screen name='GiftDetails' component={GiftDetails} options={{ statusBarColor: '#ff3d00', headerShown: false }} />
