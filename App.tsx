...
export default function App() {
  return (
    <StripeProvider publishableKey='pk_test_51 NpOZ4GY4n5u6WbIlWOsccAKTTMLq7xnjfG8fFboidp6jZCx2XlssuBHyNbvBsqfGDkbVkZH2Knka498eIzAjdPZ00YZBjdzik'>
      ...
      <Stack.Screen name='HomeScreen' component={HomeScreen}options={{ headerShown:false,statusBarColor:'#ff3d00'}}/>
      ...
      <Stack.Screen name='ForgotScreen' component={ForgotScreen} options={( ) => ({headerTintColor:'white',title:'Forgot Password',headerTitleAlign:'center',statusBarColor:'#ff3d00',headerStyle: {backgroundColor: '#ff3d00'}, headerTitleContainerStyle: {top: 800}, headerTitleStyle: {fontWeight: '600',fontSize:15},})}/>      
      </Stack.Navigator>
      </NavigationContainer>
      </StripeProvider>
);
